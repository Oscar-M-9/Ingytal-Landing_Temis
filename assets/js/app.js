$(document).ready(function () {
    ...
    */
    ...
    $("#btn-video-yt").click(function () {
        ...
        const iframeYT = `<iframe class="youtube-iframe" src="https://www.youtube.com/embed/haae6QPAUlg?autoplay=1&rel=0&enablejsapi=1" title="Temis | Simplifica tu Gestión Legal" autoplay="true" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;
